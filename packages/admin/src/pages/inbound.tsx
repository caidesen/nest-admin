...
type ListItemType = api.inbound.list.Output[number];
type FormType = api.inbound.create.Input;
      ...
      <ProTable<ListItemType>
          ...
          },
          {
            ...
            render: (text, record, index, action) => [
              <ModalForm<FormType>
                ...
                onFinish={async (val) => {
                  await fetchWrap(api.inbound.update)({
                    ...val,
                    id: record.id,
                  });
                  action?.reload();
        ...
        toolBarRender={(action) => [
          <ModalForm<FormType>
            ...
            onFinish={async (val) => {
              await fetchWrap(api.inbound.create)(val);
              action?.reload();
        ...
        request={async () => {
          const res = await fetchWrap(api.inbound.list)();
          return {
            data: res,
            total: res.length,
            success: true,
